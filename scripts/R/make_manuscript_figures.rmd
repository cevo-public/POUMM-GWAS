...
png(file = paste(FIGDIR, "spvl_on_tree.png", sep = "/"),
    ...
    units = "cm",
    res = 300)
plot_grid(v_tree + theme(legend.position = "none"),
          h_tree + theme(legend.position = "none"),
          spvl_tree_same_scale + theme(legend.position = "none"),
          get_legend(v_tree), get_legend(h_tree), get_legend(spvl_tree_same_scale),
