...
single_col_width <- 8.7  # cm
double_col_width <- 11.4  # cm
...
png(
  ...
  width = double_col_width, height = single_col_width, units = "cm", res = 300)
...
png(filename = "figures/simulation_results.png", width = double_col_width, height = single_col_width, unit = "cm", res = 300)
