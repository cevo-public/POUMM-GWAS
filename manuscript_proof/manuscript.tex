...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width = \linewidth]{simulation_setup.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=\linewidth]{simulation_results}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=\linewidth]{example_simulation_trait_values.pdf}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width = \linewidth]{tip_trait_correlation.pdf}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width = \linewidth]{application_experimental_setups.pdf}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=\linewidth]{gwas_results}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width = \linewidth]{gwas_results_xanthomonas}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.7\linewidth]{sigma_vs_alpha.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.7\linewidth]{spvl_calculation_comparison.png}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.7\linewidth]{poumm_parameter_estimates.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \linewidth]{spvl_on_tree.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.462\linewidth]{trait_values.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \linewidth]{qdr_on_tree_arboricola.png}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.7\linewidth]{poumm_parameter_estimates_arboricola.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.462\linewidth]{trait_values_arboricola.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \linewidth]{qq_plots_arabidopsis_xanthomonas.png}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{host_genotype_pca.png}
