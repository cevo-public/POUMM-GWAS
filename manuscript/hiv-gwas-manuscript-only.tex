...
\bibliographystyle{my_natbib} % need to prefix with manuscript/ to compile on overleaf, removed for submission
\bibliography{references_synced} % need to prefix with manuscript/ to compile on overleaf, removed for submission
