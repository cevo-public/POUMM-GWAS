...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{1cm}p{2cm}p{2.5cm}p{1cm}p{2cm}p{1cm}p{2cm}} % {lrrrrrr} {llclcccc}
			...
			\hline
		\end{tabular}
		\caption{Top association results from \cite{McLaren2015} compared to association results in the current study.}
		\label{tab:comp-gwas}
	\end{center}
\end{table}
